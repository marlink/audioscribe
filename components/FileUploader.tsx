    ...
    <div className="w-full">
      <div
        ...
        className={`
          ...
          ${disabled ? 'opacity-50 cursor-not-allowed bg-bg-page border-border-default' : 'cursor-pointer'}
          ${isDragOver ? 'border-brand-primary bg-brand-subtle ring-4 ring-brand-glow' : 'border-border-default hover:border-brand-primary hover:bg-bg-elevated'}
        `}
      >
        <input
          type="file"
        ...
        <div className="bg-brand-subtle p-4 rounded-full mb-4 shadow-[0_0_15px_var(--accent-glow)]">
      ...
      {errorMessage && (
        <div className="mt-3 p-3 bg-status-error-bg border border-status-error/30 rounded-lg flex items-center gap-2 text-sm text-status-error animate-fade-in">
