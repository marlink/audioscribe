...
const ThemeToggle: React.FC = () => {
    ...
    return (
        <button
            onClick={toggleTheme}
            className="p-2 rounded-lg bg-bg-surface hover:bg-bg-elevated border border-border-subtle hover:border-border-default transition-all focus:outline-none focus:ring-2 focus:ring-brand-primary"
